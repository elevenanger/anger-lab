...
class AwsServiceTest {
    ...
    private final Oss aws = new AwsService(OssConfigurationStore.getOne("mac_15"));
    ...
    void deleteObject() {
        ...
        assertDoesNotThrow(() ->
                response.set(aws.deleteObject(BUCKET, "/performance/concurrency/composingobject/pom.xml")));
        System.out.println(response);
    }
